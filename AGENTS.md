...
|---|---|
| `core/lua/` | `CobaltMachineTest`, `FileSystemReadLineTest`, `TextUtilsJsonTest`, `SettingsAPITest`, `ColorsAPITest`, `CcPrettyTest`, `CcImageNftTest` |
| `core/apis/` | `TermAPITest`, `OSAPITest`, `FSAPITest`, `HTTPResponseTest` |
