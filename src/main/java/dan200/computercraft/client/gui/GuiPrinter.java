...
public class GuiPrinter extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        String title = this.m_printer.hasCustomInventoryName() ? this.m_printer.getInventoryName()
            : I18n.format(this.m_printer.getInventoryName(), new Object[0]);
