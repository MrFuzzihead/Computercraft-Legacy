      ...
      if (!origin) {
         ...
         if (terminal != null) {
            ...
            if (redraw) {
               ...
               fontRenderer.drawString(emptyLine, 0, 0, terminal.getTextColourLine(0), terminal.getBackgroundColourLine(0), marginXSize, marginXSize, greyscale);
               GL11.glTranslatef(0.0F, (marginYSize + height * FixedWidthFontRenderer.FONT_HEIGHT) / marginSquash, 0.0F);
               fontRenderer.drawString(
                  emptyLine, 0, 0, terminal.getTextColourLine(height - 1), terminal.getBackgroundColourLine(height - 1), marginXSize, marginXSize, greyscale
               );
               GL11.glPopMatrix();
            ...
            mc.func_110434_K().bindTexture(grey);
         ...
         GL11.glDisable(3008);
         Minecraft mc = Minecraft.getMinecraft();
         mc.func_110434_K().bindTexture(black);
         tessellator.func_78382_b();
         tessellator.func_78375_b(0.0F, 0.0F, 1.0F);
         tessellator.addVertexWithUV(-0.03125, -ySize - 0.03125F, 0.0, 0.0, 1.0);
         tessellator.addVertexWithUV(xSize + 0.03125F, -ySize - 0.03125F, 0.0, 1.0, 1.0);
