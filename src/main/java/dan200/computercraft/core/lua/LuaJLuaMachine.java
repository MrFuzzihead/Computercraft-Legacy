...
public class LuaJLuaMachine implements ILuaMachine {
    ...
    public LuaJLuaMachine(Computer computer) {
        ...
        coroutine.set("create", new OneArgFunction() {
            ...
            public LuaValue call(LuaValue value) {
                LuaThread thread = native_coroutine_create.call(value)
                    .checkthread();
    ...
    public void loadBios(InputStream bios) {
        if (this.m_mainRoutine == null) {
            try {
                ...
                LuaValue program = this.m_assert
                    .call(this.m_loadString.call(LuaValue.valueOf(biosText), LuaValue.valueOf("bios")));
    ...
    public void handleEvent(String eventName, Object[] arguments) {
        if (this.m_mainRoutine != null) {
            if (this.m_eventFilter == null || eventName == null
                || eventName.equals(this.m_eventFilter)
                            ...
                            results = object.callMethod(new ILuaContext() {
                                ...
                                public Object[] yield(Object[] yieldArgs) throws InterruptedException {
                                    try {
                                        ...
                                        Varargs resultsx = LuaJLuaMachine.this.m_coroutine_yield
                                            .invoke(LuaValue.varargsOf(yieldValues));
                                            ...
                                            try {
                                                ...
                                                if (resultsx != null) {
                                                    ...
                                                    LuaJLuaMachine.this.m_computer
                                                        .queueEvent("task_complete", eventArguments);
                                                } else {
                                                    LuaJLuaMachine.this.m_computer
                                                        .queueEvent("task_complete", new Object[] { taskID, true });
                                                }
                                            } catch (LuaException var4) {
                                                LuaJLuaMachine.this.m_computer.queueEvent(
                                                    "task_complete",
                                                    new Object[] { taskID, false, var4.getMessage() });
                                            } catch (Throwable var5x) {
                                                LuaJLuaMachine.this.m_computer.queueEvent(
                                                    "task_complete",
                                                    new Object[] { taskID, false,
                                                        "Java Exception Thrown: " + var5x.toString() });
                                            }
                                        }
                                    };
