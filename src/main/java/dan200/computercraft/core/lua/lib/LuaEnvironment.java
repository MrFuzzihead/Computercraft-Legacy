...
public class LuaEnvironment implements ILuaEnvironment {
    ...
    private static class LuaAPI implements ILuaAPI, ILuaObjectWithArguments, IExtendedLuaObject {
        ...
        private final dan200.computercraft.api.lua.ILuaAPI api;
        private final ILuaAPIFactory factory;

        private LuaAPI(dan200.computercraft.api.lua.ILuaAPI api, ILuaAPIFactory factory) {
            this.api = api;
        ...
        public Map<Object, Object> getAdditionalData() {
            return api instanceof IExtendedLuaObject ? ((IExtendedLuaObject) api).getAdditionalData()
