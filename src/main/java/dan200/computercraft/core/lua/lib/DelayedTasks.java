...
import dan200.computercraft.api.lua.IExtendedLuaTask;
...
public class DelayedTasks {
    ...
    private static final class LuaTask {
        ...
        public boolean update() {
            if (remaining < 0) {
                ComputerCraft.logger.warn("Task has negative time remaining!");
                return true;
            }
            ...
            if (remaining == 0) {
                ...
                try {
                    ...
                    ComputerCraft.logger.error("Error in task: ", e);
