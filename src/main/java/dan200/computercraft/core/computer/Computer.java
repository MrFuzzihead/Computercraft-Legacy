...
public class Computer {
    ...
    public void advance(double _dt) {
        ...
        synchronized (this.m_terminal) {
            boolean blinking = this.m_terminal.getCursorBlink() && this.m_terminal.getCursorX() >= 0
    ...
    public IWritableMount getRootMount() {
        if (this.m_rootMount == null) {
            this.m_rootMount = this.m_environment
                .createSaveDirMount("computer/" + this.assignID(), this.m_environment.getComputerSpaceLimit());
        }
    ...
    public void setPeripheral(int side, IPeripheral peripheral) {
        synchronized (this.m_peripherals) {
            ...
            if (existing == null && peripheral != null || existing != null && peripheral == null
