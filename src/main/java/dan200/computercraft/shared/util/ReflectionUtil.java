...
public class ReflectionUtil {
   ...
   public static <T> T safeInvoke(Method method, Object object, Object[] arguments, Class<T> resultClass) {
      if (method != null) {
         try {
            if (object == null && Modifier.isStatic(method.getModifiers()) || method.getDeclaringClass().isInstance(object)) {
   ...
   public static <T> T safeGet(Field field, Object object, Class<T> resultClass) {
      if (field != null) {
         try {
            if (object == null && Modifier.isStatic(field.getModifiers()) || field.getDeclaringClass().isInstance(object)) {
