...
public abstract class BlockGeneric extends Block implements ITileEntityProvider {
    ...
    public final int onBlockPlaced(World world, int x, int y, int z, int side, float hitX, float hitY, float hitZ,
        int damage) {
    ...
    public final boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX,
    ...
    public final void onNeighborBlockChange(World world, int x, int y, int z, Block neighbour) {
        TileEntity tile = world.getTileEntity(x, y, z);
        if (tile != null && tile instanceof TileGeneric) {
            TileGeneric generic = (TileGeneric) tile;
    ...
    public final void addCollisionBoxesToList(World world, int x, int y, int z, AxisAlignedBB bigBox, List list,
        Entity entity) {
        TileEntity tile = world.getTileEntity(x, y, z);
        if (tile != null && tile instanceof TileGeneric) {
            TileGeneric generic = (TileGeneric) tile;
    ...
    public final IIcon getIcon(int side, int damage) {
