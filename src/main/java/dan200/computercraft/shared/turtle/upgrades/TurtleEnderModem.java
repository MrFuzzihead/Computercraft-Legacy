...
public class TurtleEnderModem implements ITurtleUpgrade {

    private final int m_id;

    public TurtleEnderModem(int id) {
        this.m_id = id;
    }
    ...
    public String getUnlocalisedAdjective() {
        return "upgrade.computercraft:advanced_wireless_modem.adjective";
    }
    ...
    public ItemStack getCraftingItem() {
        return new ItemStack(ComputerCraft.Blocks.advancedWirelessModem, 1, 0);
    }
    ...
    public IIcon getIcon(ITurtleAccess turtle, TurtleSide side) {
        ...
        return TileAdvancedWirelessModem.getItemTexture(3, active);
    }

    @Override
    public IPeripheral createPeripheral(ITurtleAccess turtle, TurtleSide side) {
        return new TurtleEnderModem.Peripheral(turtle);
    }
    ...
    public void update(ITurtleAccess turtle, TurtleSide side) {
        if (!turtle.getWorld().isRemote) {
            ...
            if (peripheral instanceof TurtleEnderModem.Peripheral modemPeripheral) {
    ...
    private static class Peripheral extends AdvancedWirelessModemPeripheral implements IPeripheral {
        ...
        public boolean equals(IPeripheral other) {
            if (other instanceof TurtleEnderModem.Peripheral otherModem) {
