...
public abstract class ItemTurtleBase extends ItemComputerBase implements ITurtleItem {
    ...
    public abstract ItemStack create(int var1, String var2, Colour var3, ITurtleUpgrade var4, ITurtleUpgrade var5,
        int var6, ResourceLocation var7, ResourceLocation var8);
    ...
    public void setupTurtleAfterPlacement(ItemStack stack, ITurtleTile turtle) {
        ...
        for (TurtleSide side : TurtleSide.values()) {
            turtle.getAccess()
                .setUpgrade(side, this.getUpgrade(stack, side));
        }
    ...
    public String getItemStackDisplayName(ItemStack stack) {
        ...
        if (left != null && right != null) {
            return StatCollector.translateToLocalFormatted(
                ...
                new Object[] { StatCollector.translateToLocal(right.getUnlocalisedAdjective()),
                    StatCollector.translateToLocal(left.getUnlocalisedAdjective()) });
        } else if (left != null) {
            return StatCollector.translateToLocalFormatted(
                baseString + ".upgraded.name",
                new Object[] { StatCollector.translateToLocal(left.getUnlocalisedAdjective()) });
        } else {
            return right != null
