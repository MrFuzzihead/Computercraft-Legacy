...
public abstract class CCTurtleProxyCommon implements ICCTurtleProxy {
   ...
   public void registerTurtleUpgrade(ITurtleUpgrade upgrade) {
      ...
      if (id >= 0 && id < 64) {
         throw new RuntimeException("Error registering '" + upgrade.getUnlocalisedAdjective() + " Turtle'. UpgradeID '" + id + "' is reserved by ComputerCraft");
      } else {
   ...
   public void setEntityDropConsumer(Entity entity, IEntityDropConsumer consumer) {
      if (!this.m_dropConsumers.containsKey(entity)) {
         boolean captured = (Boolean)ObfuscationReflectionHelper.getPrivateValue(Entity.class, entity, new String[]{"captureDrops"});
         if (!captured) {
            ObfuscationReflectionHelper.setPrivateValue(Entity.class, entity, new Boolean(true), new String[]{"captureDrops"});
            ArrayList<EntityItem> items = (ArrayList<EntityItem>)ObfuscationReflectionHelper.getPrivateValue(
               Entity.class, entity, new String[]{"capturedDrops"}
            );
      ...
      if (id >= 0 && id < 32767) {
         ...
         if (existing != null) {
            ...
            if (upgrade.getUpgradeID() < 64) {
               List recipeList = CraftingManager.getInstance().func_77592_b();
               ItemStack craftingItem = upgrade.getCraftingItem();

               for (ComputerFamily family : ComputerFamily.values()) {
                  if (isUpgradeSuitableForFamily(family, upgrade)) {
                     ItemStack baseTurtle = TurtleItemFactory.create(-1, null, null, family, null, null, 0, null, null);
                     if (baseTurtle != null) {
                        ItemStack craftedTurtle = TurtleItemFactory.create(-1, null, null, family, upgrade, null, 0, null, null);
                        ItemStack craftedTurtleFlipped = TurtleItemFactory.create(-1, null, null, family, null, upgrade, 0, null, null);
                        ...
                        for (ITurtleUpgrade otherUpgrade : this.m_turtleUpgrades.values()) {
                           if (otherUpgrade.getUpgradeID() < 64 && isUpgradeSuitableForFamily(family, otherUpgrade)) {
                              ItemStack otherCraftingItem = otherUpgrade.getCraftingItem();
                              ItemStack otherCraftedTurtle = TurtleItemFactory.create(-1, null, null, family, null, otherUpgrade, 0, null, null);
                              ItemStack comboCraftedTurtle = TurtleItemFactory.create(-1, null, null, family, upgrade, otherUpgrade, 0, null, null);
                              ItemStack otherCraftedTurtleFlipped = TurtleItemFactory.create(-1, null, null, family, otherUpgrade, null, 0, null, null);
                              ItemStack comboCraftedTurtleFlipped = TurtleItemFactory.create(-1, null, null, family, otherUpgrade, upgrade, 0, null, null);
         ...
         throw new RuntimeException("Error registering '" + upgrade.getUnlocalisedAdjective() + " Turtle'. UpgradeID '" + id + "' is out of range");
      }
   }
   ...
   private void registerItems() {
      ...
      RecipeSorter.register("computercraft:turtle_upgrade", TurtleUpgradeRecipe.class, Category.SHAPED, "after:minecraft:shapeless");
      GameRegistry.addRecipe(
         new TurtleRecipe(
            new Item[]{
               ...
               Items.field_151042_j,
               Items.field_151042_j,
               Item.getItemFromBlock(ComputerCraft.Blocks.computer),
               Items.field_151042_j,
               Items.field_151042_j,
               Item.getItemFromBlock(Blocks.field_150486_ae),
               Items.field_151042_j
            },
      ...
      GameRegistry.addRecipe(
         new ImpostorRecipe(
            ...
            3,
            new ItemStack[]{
               iron, iron, iron, iron, ComputerItemFactory.create(-1, null, ComputerFamily.Normal), iron, iron, new ItemStack(Blocks.field_150486_ae, 1), iron
            },
      ...
      GameRegistry.addRecipe(
         new ImpostorRecipe(
            ...
            new ItemStack[]{
               ...
               gold,
               gold,
               new ItemStack(Blocks.field_150486_ae, 1),
               gold
            },
      ...
      ComputerCraft.Upgrades.diamondSword = new TurtleSword(3, "upgrade.minecraft:diamond_sword.adjective", Items.field_151048_u);
      this.registerTurtleUpgradeInternal(ComputerCraft.Upgrades.diamondSword);
      ComputerCraft.Upgrades.diamondShovel = new TurtleShovel(4, "upgrade.minecraft:diamond_shovel.adjective", Items.field_151047_v);
      this.registerTurtleUpgradeInternal(ComputerCraft.Upgrades.diamondShovel);
      ComputerCraft.Upgrades.diamondPickaxe = new TurtleTool(5, "upgrade.minecraft:diamond_pickaxe.adjective", Items.field_151046_w);
      this.registerTurtleUpgradeInternal(ComputerCraft.Upgrades.diamondPickaxe);
      ComputerCraft.Upgrades.diamondAxe = new TurtleAxe(6, "upgrade.minecraft:diamond_axe.adjective", Items.field_151056_x);
      this.registerTurtleUpgradeInternal(ComputerCraft.Upgrades.diamondAxe);
      ComputerCraft.Upgrades.diamondHoe = new TurtleHoe(7, "upgrade.minecraft:diamond_hoe.adjective", Items.field_151012_L);
