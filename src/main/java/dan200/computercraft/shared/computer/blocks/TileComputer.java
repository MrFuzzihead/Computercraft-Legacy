...
public class TileComputer extends TileComputerBase {
   ...
   protected ServerComputer createComputer(int instanceID, int id) {
      ...
      ServerComputer computer = new ServerComputer(this.getWorldObj(), id, this.m_label, instanceID, family, 51, 19);
   ...
   public IIcon getTexture(int side) {
      IComputer computer = this.getComputer();
      return getTexture(
         side, this.getFamily(), computer != null ? computer.isOn() : false, computer != null ? computer.isCursorDisplayed() : false, this.getDirection()
      );
   }
