      ...
      switch (method) {
            ...
            if (arguments.length >= 1 && arguments[0] instanceof String) {
               ...
               context.issueMainThreadTask(
                  new ILuaTask() {
                     @Override
                     public Object[] execute() throws LuaException {
                        CommandBlockPeripheral.this.m_commandBlock.func_145993_a().func_145752_a(command);
                        CommandBlockPeripheral.this.m_commandBlock
                           .getWorldObj()
                           .markBlockForUpdate(
         ...
         case 2:
            return context.executeMainThreadTask(new ILuaTask() {
               @Override
               public Object[] execute() throws LuaException {
                  CommandBlockPeripheral.this.m_commandBlock.func_145993_a().func_145755_a(CommandBlockPeripheral.this.m_commandBlock.getWorldObj());
                  int result = CommandBlockPeripheral.this.m_commandBlock.func_145993_a().func_145760_g();
