...
public class TileAdvancedWirelessModem extends TileModemBase {
    ...
    protected ModemPeripheral createPeripheral() {
        return new TileAdvancedWirelessModem.Peripheral(this);
    }

    private static class Peripheral extends AdvancedWirelessModemPeripheral {
        ...
        public boolean equals(IPeripheral other) {
            if (other instanceof Peripheral otherModem) {
